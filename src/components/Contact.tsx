          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">anmuce03@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+57 317 755 6815</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="bg-gray-100 p-3 rounded-lg hover:bg-gray-800 transition-colors">
                ...
                <a href="#" className="bg-gray-100 p-3 rounded-lg hover:bg-blue-400 transition-colors">
                  <svg className="w-6 h-6 text-gray-600 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
